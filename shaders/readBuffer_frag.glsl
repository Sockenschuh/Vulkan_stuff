...
void main() {
    ...
    outColor = outputArray.data[index]%100 >= 10 ? vec4(1.0) : vec4(0.0);
	//outColor = outputArray.data[0] > 0 ? vec4(1.0) : vec4(0.0);
	
	uint count = outputArray.data[index]%10;
	...
	if (outputArray.data[index]/100 == 1){
